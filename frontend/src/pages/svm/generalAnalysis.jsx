		...
		<>
			{isLoading ? (
				...
				<>
					...
					<Divider />
					<Title level={4}>Selecciona las variables dependientes</Title>
					<Select
						availableOptions={getColsNames(data["table"])}
						onChange={setXvariables}
						selectedItems={xVariables}
						mode="multiple"
					/>
					<Title level={4}>Selecciona las variable independiente</Title>
					<Select
						availableOptions={getColsNames(data["table"])}
						onChange={setYvariable}
						selectedItems={yVariable}
					/>
					<Divider />
					{/* <Title level={4}>Algoritmo</Title>
					<Select
						availableOptions={["classification", "prediction"]}
						onChange={setAlgorithm}
						selectedItems={algorithm}
					/> */}
				</>
			)}
		</>
